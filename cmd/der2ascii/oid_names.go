...
var oidNames = []struct {
	...
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x01, 0x07}, "ipAddrBlocks"},
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x01, 0x08}, "autonomousSysIds"},
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x01, 0x0b}, "subjectInfoAccess"},
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x01, 0x1c}, "ipAddrBlocks-v2"},
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x01, 0x1d}, "autonomousSysIds-v2"},
	...
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x03, 0x2e}, "bgpsec-router"},
	{[]byte{0x55, 0x1d, 0x25, 0x00}, "anyExtendedKeyUsage"},

	// X.509 policy IDs.
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x02, 0x02}, "unotice"},
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x0e, 0x02}, "ipAddr-asNumber"},
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x0e, 0x03}, "ipAddr-asNumber-v2"},
	...
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x30, 0x05}, "caRepository"},
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x30, 0x0a}, "rpkiManifest"},
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x30, 0x0b}, "signedObject"},
	{[]byte{0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x30, 0x0d}, "rpkiNotify"},

	// PKCS #9 attributes.
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x01}, "emailAddress"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x02}, "unstructuredName"},
	...
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x05}, "signingTime"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x06}, "counterSignature"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x07}, "challengePassword"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x08}, "unstructuredAddress"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x09}, "extendedCertificateAttributes"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x0a}, "issuerAndSerialNumber"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x0b}, "passwordCheck"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x0c}, "publicKey"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x0d}, "signingDescription"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x0e}, "extensionRequest"},
	...
	// S/MIME attributes.
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x01}, "receiptRequest"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x02}, "securityLabel"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x03}, "mlExpandHistory"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x04}, "contentHint"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x05}, "msgSigDigest"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x07}, "contentIdentifier"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x09}, "equivalentLabels"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x0a}, "contentReference"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x0b}, "encrypKeyPref"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x0c}, "signingCertificate"},

	// S/MIME capabilities.
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x0b, 0x01}, "preferBinaryInside"},
	...
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x01}, "receipt"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x02}, "authData"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x06}, "contentInfo"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x18}, "routeOriginAuthz"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x1a}, "rpkiManifest"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x23}, "rpkiGhostbusters"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x2f}, "geofeedCSVwithCRLF"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x30}, "signedChecklist"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x31}, "ASPA"},
	{[]byte{0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x01, 0x32}, "signedTAL"},
